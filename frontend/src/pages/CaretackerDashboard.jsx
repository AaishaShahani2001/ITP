...
function closeConfirm() {
  ...
  // load grooming + daycare and merge on client (keeps backend simple)
  ...
  function exportCaretakerPDF() {
    ...
    const body = filtered.map((r) => [
      ...
      (Number(r.amount) || 0).toFixed(2), // show fee
    ]);

    autoTable(doc, {
      startY: 140,
      head: [["Date", "Time", "Service", "Package", "Pet", "Owner", "Phone", "Status", "Payment", "Fee (Rs.)"]],
      body,
      theme: "grid",
    ...
    doc.setFontSize(10);
    y += 16;
    doc.text(`Total appointments: ${total}`, 40, y); y += 14;
    doc.text(`By service: grooming ${byService.grooming || 0}, daycare ${byService.daycare || 0}`, 40, y); y += 14;
    doc.text(
    ...
    doc.setFontSize(10);
    y += 16;
    doc.text(`Total (all): Rs. ${revenueTotal.toFixed(2)}`, 40, y); y += 14;
    doc.text(`Collected (paid): Rs. ${revenuePaid.toFixed(2)}`, 40, y); y += 14;
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-5">
        ...
        <input
          ...
          placeholder="Search owner / phone / pet / package…"
